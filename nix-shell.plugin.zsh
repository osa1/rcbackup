...
# Theme example: https://gist.github.com/chisui/0d12bd51a5fd8e6bb52e6e6a43d31d5e#file-agnoster-nix-zsh-theme
...
function nix-shell() {
  ...
  then
    ...
    NIX_BUILD_SHELL="$NIX_SHELL_PLUGIN_DIR/zsh-nix-shell/buildShellShim.zsh" \
