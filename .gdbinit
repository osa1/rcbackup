...
source /home/omer/gdb_script/pygdbdis.py
source /home/omer/gdb_script/script.py

## rest is modified/customized version of https://github.com/gdbinit/Gdbinit/blob/master/gdbinit
...
# color codes
set $BLACK = 0
# Don't use RED, it's not visible in my terminal color scheme
#set $RED = 1
set $GREEN = 2
set $YELLOW = 3
set $BLUE = 4
